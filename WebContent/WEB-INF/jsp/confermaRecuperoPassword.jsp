...
<title>Aste On Line - Conferma Recupero Password</title>
			...
			<div class="centralBoxOperations">
				...
				<p>&nbsp;</p>
  				...
  				<div class="greyInnerLayer">
					...
					<h2 align="center"> ${ messaggio }</h2>
									    
				    <p>&nbsp;</p>
				    
				    <p align="center">
				    	<input type="button" value="Torna indietro" id="bottone-Accedi" onclick="href=location.href='recuperoPassword.jsp';"/>
				    </p>
