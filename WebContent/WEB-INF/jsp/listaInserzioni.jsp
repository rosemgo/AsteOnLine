...
<title>Aste On Line - Inserzioni</title>
<meta name="" content="">
			   ...
			   <p>&nbsp;</p>
			    <c:if test="${ numeroInserzioni > 0 }">
				         ...
				         <table style="margin-left:auto; margin-right:auto; font-size: 15px; width: auto;" border="0" cellpadding="5" cellspacing="5">
					      ...
					      <c:forEach items="${intervalloListaInserzioni}" var="inserzioneLista" > 
					     		<tr>
					     		  
					     		  <td id="td2" align="center"><img src="${inserzioneLista.immagini[0].foto }"  width="80px" height="80px"></img></td>
						          <td id="td2" align="center">${inserzioneLista.titolo }</td>
						          <td id="td2" align="center">${inserzioneLista.prodotto.nome } </td>
						          <td id="td2" align="center">${inserzioneLista.prodotto.categoria.nome } </td>
						     	  <td id="td2" align="center">${inserzioneLista.dataScadenzaString}</td>
						          <td id="td2" align="center">${inserzioneLista.venditore.nome} ${inserzioneLista.venditore.cognome}</td>
						          <td id="td2" align="center">${inserzioneLista.stato}</td>
						          						           
						          <td id="td2" align="center" width="70px"><a href="ServletDettagliInserzione?idInserzione=${ inserzioneLista.idInserzione }" target="_new"> <img src="immagini/dettagli.png" alt="Dettagli" title="Dettagli" height="30px">  </a></td>
				          			
				          		  <c:if test="${inserzioneLista.stato eq 'in asta' || inserzioneLista.stato eq 'scaduta'}">
				          		     <td id="td2" align="center" width="70px"><a href="ServletEliminaInserzione?idInserzione=${ inserzioneLista.idInserzione }"> <img alt="Elimina" title="Elimina" src="immagini/rimuovi.png" height="30px"> </a></td>
				          		  </c:if>
				      ...
				      <p align="center">
				     	  	<
				     	  	<c:forEach var="i" begin="1" end="${ numeroPagineInserzioni}">
				     	  		
				     	  		  <a style="color: #C6310C" href="ServletListaInserzioni?idNumPagina=${ i }" > ${ i } </a>	
