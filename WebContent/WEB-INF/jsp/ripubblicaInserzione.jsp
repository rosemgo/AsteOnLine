...
<title>Aste On Line - Ripubblica inserzione</title>
<meta name="" content="">
...
<!-- 				 <p>Date: <input type="text" id="datepicker" /></p> -->
    				...
    				<form action="ServletRipubblicaInserzione" method="post">
    					...
    					<p>Data scadenza*</p>
    					<p>
    						<input class="tcal tcalInput tcalActive" type="text" value="" name="data_scadenza" value="${ inserzione.dataScadenza }" >
    					</p>
    					
<!--     					<p>Durata asta*</p> -->
<!-- 					    <p> -->
<!-- 						    <select name="durataAsta" size="1" id="campoTesto4"> -->
<!-- 						  		<option>1 gg</option> -->
<!-- 						  		<option>2 gg</option> -->
<!-- 						  		<option>3 gg</option> -->
<!-- 								<option>4 gg</option> -->
...
<!-- 								<option>60 gg</option> -->
<!-- 								<option>90 gg</option> -->
<!-- 								<option>120 gg</option> -->
<!-- 								<option>150 gg</option> -->
<!-- 								<option>180 gg</option> -->
<!-- 								<option>210 gg</option> -->
<!-- 								<option>240 gg</option> -->
<!-- 								<option>270 gg</option> -->
<!-- 								<option>300 gg</option> -->
<!-- 								<option>330 gg</option> -->
<!-- 								<option>365 gg</option> -->
<!-- 							</select> -->
<!-- 					    </p> -->
				  ...
				  <p>&nbsp;</p>
				  <h3 align="center" >Informazioni inserzione:</h3>
				  <p>&nbsp;</p>
				...
				<table style="margin-left: auto; margin-right: auto" width="600" border="0" cellspacing="5" cellpadding="5">
	             <tr>
	              	...
	              	<td width="60" id="td1">Categoria:</td>
	                <td width="100" id="campoTesto2">${ inserzione.prodotto.categoria.nome  }</td>
	                <td width="70" id="td1">Produttore:</td>
	                <td width="100" id="campoTesto2">${ inserzione.prodotto.produttore.nome }</td>
	                
	             <tr>
	             
	                <td width="170" id="td1">Prodotto: :</td>
	                <td width="100" id="campoTesto2">${ inserzione.prodotto.nome }</td>
	                <td width="170" id="td1">Titolo:</td>
	                <td width="100" id="campoTesto2">${ inserzione.titolo }</td>
	             
	             </tr>
	             <tr>  	              
	                <td width="170" id="td1">Descrizione:</td>
	                <td width="100" id="campoTesto2">${ inserzione.descrizione  }</td>
