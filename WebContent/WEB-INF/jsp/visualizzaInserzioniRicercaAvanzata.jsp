...
<title>Aste On Line - Visualizza Ricerca Avanzata Inserzioni</title>
<meta name="" content="">
				...
				<p>&nbsp;</p>
			      ...
			      <c:if test="${ numeroInserzioni > 0 }">
				         <table width="830" align="center" border="0" cellpadding="5" cellspacing="5">
				     	  ...
				     	  <p align="center">
				     	  	<
				     	  	<c:forEach var="i" begin="1" end="${ numeroPagineRicercaAvanzataInserzione }">
				     	  		
				     	  		  <a style="color: #C6310C" href="ServletRicercaAvanzataInserzione?idNumPagina=${ i }" > ${ i } </a>	
