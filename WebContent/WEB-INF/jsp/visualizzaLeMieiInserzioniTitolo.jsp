...
<%--For alternativo   	<c:forEach var="i" begin="0" end="${ numeroInserzioni - 1 }"> --%>
					    <c:forEach items="${intervalloInserzioniCercate}" var="intervalloInserzioniCercate" > 
					     	
					        <tr>
					         
					          <td id="td3" align="center"><img src="${intervalloInserzioniCercate.immagini[0].foto }"  width="90px" height="90px"></img></td>
					          <td id="td3" align="center">${intervalloInserzioniCercate.titolo }</td>
					          <td id="td3" align="center">${intervalloInserzioniCercate.prezzoIniziale } €</td>
					         <c:choose>
					          	<c:when test="${intervalloInserzioniCercate.prezzoAggiornato > 0}">
					          		<td id="td3" align="center">${intervalloInserzioniCercate.prezzoAggiornato } €</td>					          		
					          	</c:when>
					          	<c:otherwise>
					          		<td id="td3" align="center">${intervalloInserzioniCercate.prezzoIniziale } €</td>
					          	</c:otherwise>				          			          
					          </c:choose>    
					          <td id="td1" align="center">${intervalloInserzioniCercate.stato }</td>
					          
					          <td width="70" align="center"><a class="b" href="ServletDettagliInserzione?idInserzione=${intervalloInserzioniCercate.idInserzione }" target="_new"> <img src="immagini/dettagli.png" alt="Dettagli" title="Dettagli" height="30px"> </a></td>
					          <c:choose>
						          <c:when test="${intervalloInserzioniCercate.stato eq 'scaduta' }">         
							          <td width=70  align="center"><a href="ServletControlloRipubblicaInserzione?idInserzione=${intervalloInserzioniCercate.idInserzione}"> <img alt="Ripubblica" title="Ripubblica" src="immagini/ripubblica.png" height="30px"> </a></td>
							          <td width="70" align="center"><a href="ServletRimuoviInserzioneLeMieInserzioni?idInserzione=${intervalloInserzioniCercate.idInserzione}"> <img alt="Rimuovi" title="Rimuovi" src="immagini/rimuovi.png" height="30px"> </a></td>  
						          </c:when>
						          <c:when test="${intervalloInserzioniCercate.stato eq 'in asta' && empty intervalloInserzioniCercate.acquirente}">
						         	 <td width="70" align="center"><a class="b" href="ServletControlloModificaInserzione?idInserzione=${intervalloInserzioniCercate.idInserzione }"> <img alt="Modifica" title="Modifica" src="immagini/modifica.png" height="30px"> </a></td>  
						          </c:when>
					          </c:choose>
				      ...
				      <p align="center">
				     	  	...
				     	  	<c:forEach var="i" begin="1" end="${ numeroPagineRicercaPerTitolo }">
				     	  		  ...
				     	  		  <a style="color: #C6310C" href="ServletRicercaLeMieInserzioniTitolo?idNumPagina=${ i }" > ${ i } </a>	
