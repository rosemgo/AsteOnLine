...
<title>Aste On Line - Visualizza Ricerca Avanzata Prodotti</title>
<meta name="" content="">
...
<!-- 		<div style="clear:both;"></div> -->
			...
			<div class="centralBoxOperations">
				...
				<p>&nbsp;</p>
			      ...
			      <p>&nbsp;</p>
			      <h2 align="center">Risultati Ricerca Avanzata</h2>
			      <p>&nbsp;</p>
			      ...
			      <c:if test="${ numeroInserzioni > 0 }">
				         <table width="830" align="center" border="0" cellpadding="5" cellspacing="5">
					          ...
					          <th ></th>
					       	...
					       	<c:forEach items="${intervalloInserzioniCercate}" var="inserzioneCercata" > 
					     		<tr>
						          ...
						          <td id="td2" align="center">${inserzioneCercata.prodotto.produttore.nome } </td>
				     	  ...
				     	  <p align="center">
				     	  	<
				     	  	<c:forEach var="i" begin="1" end="${ numeroPagineRicercaAvanzataProdotto }">
				     	  		
				     	  		  <a style="color: #C6310C" href="ServletRicercaAvanzataProdotto?idNumPagina=${ i }" > ${ i } </a>	
