...
public class InserisciRimuoviProdotto {
  ...
  public void testInserisciProdotto() throws Exception {
    ...
    driver.findElement(By.name("nick")).sendKeys("makAdmin");
    driver.findElement(By.name("password")).click();
    driver.findElement(By.name("password")).clear();
    driver.findElement(By.name("password")).sendKeys("marcoadmin");
    ...
    driver.findElement(By.id("campoTesto")).sendKeys("Huawei P20");
    ...
    new Select(driver.findElement(By.id("prodotto2"))).selectByVisibleText("Huawei P20");
