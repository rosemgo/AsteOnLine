...
public class AssociaDisassociaKeyword {
  ...
  public void testAssociaparolaChiave() throws Exception {
	  driver.get("http://localhost:30000/AsteOnLine/index");
	    ...
	    new Select(driver.findElement(By.id("categoria4"))).selectByVisibleText("Casa e cucina");
	    driver.findElement(By.xpath("(//option[@value='8'])[6]")).click();
	    driver.findElement(By.id("produttore4")).click();
	    new Select(driver.findElement(By.id("produttore4"))).selectByVisibleText("Rowenta");
	    driver.findElement(By.xpath("(//option[@value='20'])[2]")).click();
	    driver.findElement(By.id("prodotto4")).click();
	    new Select(driver.findElement(By.id("prodotto4"))).selectByVisibleText("Scopa elettrica RY7557WH");
	    ...
	    new Select(driver.findElement(By.id("categoria5"))).selectByVisibleText("Casa e cucina");
	    driver.findElement(By.xpath("(//option[@value='8'])[7]")).click();
	    driver.findElement(By.id("produttore5")).click();
	    new Select(driver.findElement(By.id("produttore5"))).selectByVisibleText("Rowenta");
	    driver.findElement(By.xpath("(//option[@value='20'])[2]")).click();
	    driver.findElement(By.id("prodotto5")).click();
	    new Select(driver.findElement(By.id("prodotto5"))).selectByVisibleText("Scopa elettrica RY7557WH");
	    driver.findElement(By.xpath("//option[@value='44']")).click();
